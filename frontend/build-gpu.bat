@echo off
REM Conversationaly GPU-Accelerated Build Script for Windows
...
echo.
echo ========================================
echo   Conversationaly GPU-Accelerated Build
echo ========================================
echo.
...
echo.
echo ========================================
echo   Conversationaly GPU Build Script - Help
echo ========================================
echo.
echo USAGE:
