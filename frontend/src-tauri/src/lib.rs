    ...
    builder
        ...
        .setup(|_app| {
            ...
            tauri::async_runtime::spawn(async {
                if let Err(e) = transcribe_engine::commands::transcribe_init().await {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            transcribe_engine::commands::transcribe_get_current_model,
            transcribe_engine::commands::transcribe_is_model_loaded,
            transcribe_engine::commands::transcribe_has_available_models,
            transcribe_engine::commands::transcribe_validate_model_ready,
            transcribe_engine::commands::transcribe_transcribe_audio,
            transcribe_engine::commands::transcribe_builtin_models,
            transcribe_engine::commands::transcribe_model_languages,
            transcribe_engine::commands::transcribe_get_models_directory,
            transcribe_engine::commands::transcribe_download_model,
            transcribe_engine::commands::transcribe_cancel_download,
            ...
            transcribe_engine::commands::open_models_folder,
            // Onboarding commands
