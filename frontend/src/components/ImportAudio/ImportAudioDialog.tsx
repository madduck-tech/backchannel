      ...
      >
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            {isProcessing ? (
              <>
                <Loader2 className="h-5 w-5 animate-spin text-info-ink" />
                Importing Audio...
              </>
            ) : error ? (
              <>
              ...
              <>
                <Upload className="h-5 w-5 text-info-ink" />
                Import Audio File
              </>
            )}
          </DialogTitle>
        ...
        <div className="space-y-4 py-4">
          ...
          {!isProcessing && !error && (
            <>
              {fileInfo ? (
                <div className="bg-sunken rounded-lg p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    <FileAudio className="h-8 w-8 text-info-ink flex-shrink-0" />
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-ink-muted mt-1">
                        ...
                        <span className="text-info-ink font-medium">{fileInfo.format}</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border-2 border-dashed border-line rounded-lg p-8 text-center">
                  <FileAudio className="h-12 w-12 text-ink-faint mx-auto mb-4" />
              ...
              {fileInfo && (
                <div className="border rounded-lg">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-sm font-medium text-ink hover:bg-sunken"
                  >
          ...
          {/* Error display */}
          {error && (
            <div className="bg-danger-soft border border-danger/40 rounded-lg p-3">
