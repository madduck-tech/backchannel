...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // Same well treatment as Input — a select is a field.
      "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-line-strong bg-sunken px-3 py-2 text-sm text-ink transition-colors",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-dropdown max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-md border border-line bg-elevated text-ink shadow-pop",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 py-1.5 text-sm font-semibold text-ink", className)}
    {...props}
  />
))
