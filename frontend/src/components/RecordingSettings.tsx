  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        ...
        <div className="h-8 bg-ink/10 rounded mb-4"></div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {preferences.auto_save && (
        <div className="space-y-4">
          <div className="p-4 border rounded-lg bg-sunken">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm border border-line rounded-md hover:bg-sunken transition-colors"
            >
          ...
          <div className="p-4 border rounded-lg bg-info-soft">
            <div className="text-sm text-info-ink">
              <strong>File Format:</strong> {preferences.file_format.toUpperCase()} files
            </div>
            <div className="text-xs text-info-ink mt-1">
      ...
      {!preferences.auto_save && (
        <div className="p-4 border rounded-lg bg-warn-soft">
